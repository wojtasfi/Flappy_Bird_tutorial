...
public class FlappyBird implements ActionListener, MouseListener, KeyListener {
	...
	public int ticks, yMotion, score = 0, highscore = 0;
...
//wde
	...
	public void repaint(Graphics g) {
		...
		if (gameOver) {
			...
			g.drawString("Highscore: " + String.valueOf(highscore), 300, HEIGHT / 2 + 100);
		}

		if (!gameOver) {
			g.drawString("Score: " + String.valueOf(score), WIDTH / 2 - 170, 100);
		}
